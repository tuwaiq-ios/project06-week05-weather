...
//
//  Created by Eth Os on 20/03/1443 AH.
//
import Foundation
import UIKit
import Alamofire
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        Alamofire.request("https://api.openweathermap.org/data/2.5/weather?lat=\(lat)&lon=\(lon)&appid=\(apiKey)&units=metric").responseJSON { response in
            ...
            if let responseStr = response.result.value {
                ...
                self.hint.text = "Swipe right to see available cities"
...
//        tempLabel.text = "25"
        ...
        NSLayoutConstraint.activate([
            ...
            hint.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -30)
        ])
    }
}
